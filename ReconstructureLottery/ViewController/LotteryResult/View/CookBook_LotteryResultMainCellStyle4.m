//
//  CPLotteryResultMainCellStyle4.m
//  lottery
//
...
@interface CookBook_LotteryResultMainCellStyle4 ()
{
    ...
    IBOutlet UILabel *_resultLabel8;
    IBOutlet UILabel *_resultLabel9;
    IBOutlet UILabel *_resultLabel10;

}

@end

@implementation CookBook_LotteryResultMainCellStyle4
...
-(void)addTitle:(NSString *)title content:(NSString *)content result:(NSArray *)result
{
    ...
    if (result.count>=10) {
        ...
        _resultLabel8.text = result[7];
        _resultLabel9.text = result[8];
        _resultLabel10.text = result[9];
